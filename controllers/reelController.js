...
exports.createReel = async (req, res) => {
    try {
        console.log('Creates Reel Request Body:', req.body);
        console.log('Create Reel User:', req.user);
        ...
        if (global.io) {
            global.io.emit('new-reel', populatedReel);
        }
...
exports.deleteReel = async (req, res) => {
    try {
        ...
        // Emit socket event for real-time sync
        if (global.io) {
            global.io.emit('reel-deleted', req.params.id);
        }
